...
const Footer = () => {
  ...
  return (
    <>
      <footer className="footer lg:px-20 px-4 py-8 bg-base-100 text-base-content">
        <div className="items-center grid-flow-col">
          ...
          <p className='text-md'>Abc Constrution Ltd. <br />Providing reliable tech since 1992</p>
        </div>
        <div>
      ...
      <footer className="footer lg:px-20 px-4 py-8 border-t bg-base-200 text-base-content border-base-300">
        <div>
          <p>Copyright &copy; {date.getFullYear()} [ abc construction ] All rights reserved</p>
        </div>
