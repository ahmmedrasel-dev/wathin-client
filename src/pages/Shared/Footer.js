...
const Footer = () => {
  ...
  return (
    <>
      <footer className="footer lg:px-20 px-4 py-8 bg-slate-300">
        <div className="flex justify-center">

          <p className='text-md'><img src={logo} alt="" /></p>
        </div>
        <div>
          <span className="text-lg font-bold text-secondary">Services</span>
          <NavLink to='/' className='rounded-lg'>Home</NavLink>
          <NavLink to='/' className='rounded-lg'>About us</NavLink>
          <NavLink to='/' className='rounded-lg'>Contact</NavLink>
          <NavLink to='/' className='rounded-lg'>Services</NavLink>
        </div>
        <div>
          <span className="text-lg font-bold text-secondary">Company</span>
          <NavLink to='/' className='rounded-lg'>Home</NavLink>
          <NavLink to='/' className='rounded-lg'>About us</NavLink>
          <NavLink to='/' className='rounded-lg'>Contact</NavLink>
          <NavLink to='/' className='rounded-lg'>Services</NavLink>
      ...
      <footer className="footer lg:px-20 px-4 py-8 border-t bg-slate-900 text-base-content border-base-300 justify-center lg:justify-between">
        <div className='text-center text-white'>
          <p>Copyright &copy; {date.getFullYear()} [ Wathin ] Company Ltd.</p>
        </div>
