...
const Footer = () => {
  ...
  return (
    <>
      <footer className="footer lg:px-20 px-4 py-8 bg-base-100">
        <div className="flex justify-center">
          <p className='text-md'>Wathin Company Ltd. <br />Providing reliable tech since 1992</p>
        </div>
        <div>
      ...
      <footer className="footer lg:px-20 px-4 py-8 border-t bg-base-200 text-base-content border-base-300 justify-center lg:justify-between">
