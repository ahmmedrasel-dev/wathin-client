  ...
  return (
    <div className='xl:max-w-screen-xl lg:max-w-screen-lg md:max-w-screen-md w-full mx-auto py-10 p-4'>
      <div className='text-center pb-12'>
        ...
        <h2 className='lg:text-4xl text-2xl font-medium'>We build strong brands and grow businesses through branded <br /> services, <span className='text-error'>digital storytelling.</span></h2>
      </div>
